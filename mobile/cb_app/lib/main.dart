...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Charlie & Brown',
      theme: ThemeData(
        primarySwatch: Colors.orange, // Color Golden Pup
        useMaterial3: true,
      ),
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Función para hablar con Python
  Future<void> testConnection() async {
    ...
    try {
      // Conectamos al localhost puerto 8000 (Tu Backend)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFFF39C12), // Naranja C&B
        centerTitle: true,
      ),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              // Logo o Icono
              const Icon(Icons.pets, size: 80, color: Color(0xFF2C3E50)), // Azul C&B
